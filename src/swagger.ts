export const swaggerSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Standalone REST API for VGC team analysis. Provides Poképaste parsing, Pikalytics tournament meta scraping, and Gemini AI strategy reports.",
  },
  ...
  paths: {
    ...
    "/api/v1/parse": {
      post: {
        ...
        description:
          "Converts a raw Showdown/Poképaste team string into a structured JSON array. No scraping or AI is involved.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
    ...
    "/api/v1/scrape": {
      post: {
        ...
        description:
          "Runs a headless Puppeteer scrape on Pikalytics for each species and returns top teammates, moves, and items. The regulation dataset is controlled by the `PIKALYTICS_REGULATION` environment variable.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
              ...
              schema: {
                ...
                properties: {
                  ...
                  apiKey: {
                    type: "string",
                    description:
                      "Google Gemini API key. Overrides GOOGLE_GENAI_API_KEY env var when provided.",
                    example: "AIza...",
                  },
                },
              },
